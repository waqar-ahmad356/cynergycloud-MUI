...
const Signup = () => {
  return (
    <Box sx={{padding:{xs:"12px 13px",lg:"47px 18px"},backgroundColor:{xs:"white",lg:"#eeeeee"}}}  id="signup">
      <Box sx={{padding:{lg:"73px 178px"},display:"flex",flexDirection:{xs:"column",lg:"row"},justifyContent:{xs:"center",lg:"center"},alignItems:{xs:"center",lg:"center"},gap:{xs:"49px",lg:"94px"}}} >
        ...
        <Box sx={{display:"flex",flexDirection:"column",gap:{xs:"40px",lg:"68px"}}} >
          ...
          {/* Signup Form */}
          <Box component="form" 
          sx={{display:"flex",flexDirection:"column",justifyContent:"space-between",alignItems:"flex-start",gap:{xs:"36px",lg:"68px"}}}
           >
            
            {/* Name Input Field */}
            <Box sx={{display:"flex",flexDirection:"column",alignItems:"flex-start"}}
            >
              <Typography sx={{color:"#170F49",fontSize:{xs:"14px",lg:"28px", fontWeight:"600"}}}>Full Name</Typography>
              <TextField
                 variant="standard"
          id="name"
          InputProps={{
            ...
            <Box sx={{display:"flex",flexDirection:"column",alignItems:"flex-start"}}
            >
              <Typography sx={{color:"#170F49",fontSize:{xs:"14px",lg:"28px", fontWeight:"600"}}}>Email</Typography>
              <TextField
                 variant="standard"
          id="email"
          InputProps={{
            ...
            <Box sx={{display:"flex",flexDirection:"column",alignItems:"flex-start"}}
            >
              <Typography sx={{color:"#170F49",fontSize:{xs:"14px",lg:"28px", fontWeight:"600"}}}>Password</Typography>
              <TextField
                 variant="standard"
          id="password"
          InputProps={{
    ...
    >
     <Typography sx={{ fontSize: { xs: "11px", lg: "21px" },
        fontWeight:"700"
    ...
    >
      <img src={signup_img} alt="Signup Visual" style={{ maxWidth: "100%", height: "auto" }} />
    </Box>
      </Box>
    </Box>
  );
